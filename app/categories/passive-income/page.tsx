  ...
  },
  {
    ...
    ideas: [
      ...
      },
      {
        ...
        startup: '$0-100 (decent microphone)',
        effort: 'Low upfront, Very Low ongoing',
        timeToProfit: '1-3 months',
        description: 'License your voice to AI companies training text-to-speech models. Record a set of voice samples once, then earn royalties as your voice is used in apps, audiobooks, and assistants.',
        howToStart: [
          'Record clean, professional voice samples',
          'Apply to platforms like Respeecher, Voicify, or ElevenLabs Voice Library',
          'Set your licensing terms and pricing',
          'Promote unique voice qualities (accents, character voices)',
        ],
        pros: ['Truly passive after recording', 'Growing AI market', 'No ongoing work required'],
        cons: ['Quality microphone needed', 'Competitive for common voices', 'Ethical considerations'],
        resources: ['ElevenLabs.io', 'Respeecher.com', 'Voices.com'],
      },
      {
        title: 'Done-For-You Email Flows',
        income: '$500-3,000+/month',
        startup: '$0',
        effort: 'High upfront, Very Low ongoing',
        timeToProfit: '1-2 months',
        description: 'Create pre-built email sequences (welcome series, abandoned cart, win-back campaigns) that e-commerce stores can plug into their systems. Sell templates on Gumroad or as packages to businesses.',
        howToStart: [
          'Learn email marketing best practices and conversion copywriting',
          'Build 3-5 proven email sequences with templates',
          'Package with easy setup instructions',
          'Sell on Gumroad, Etsy, or pitch directly to Shopify store owners',
        ],
        pros: ['High perceived value', 'Businesses pay premium for done-for-you', 'Upsell customization services'],
