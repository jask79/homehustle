  ...
  },
  {
    ...
    hustles: [
      ...
      },
      {
        ...
        income: '$30-100/hour',
        startup: 'Computer + AI editing tools',
        flexibility: 'High',
        description: 'Use AI tools like Descript, Runway, and CapCut to edit videos 3-5x faster than traditional methods. YouTubers, course creators, and businesses need editors who can deliver quickly.',
        tips: ['Learn 2-3 AI editing tools deeply', 'Offer same-day turnaround as a premium', 'Specialize in a niche (podcasts, shorts, tutorials)'],
        link: 'https://www.upwork.com/freelance-jobs/video-editing/',
      },
      {
        title: 'Voice Pack Creator',
        income: '$100-1,000/pack',
        startup: 'Microphone ($50+)',
        flexibility: 'High',
        description: 'Create and sell pre-recorded voice packs—intro/outro clips, soundbites, character voices, or meditation scripts. Content creators buy these to enhance their videos without hiring voice actors.',
