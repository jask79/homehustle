...
const remoteJobs = [
  {
    ...
    link: 'https://www.amazon.jobs/en/search?country%5B%5D=USA&category%5B%5D=customer-service',
    hiring: true,
  },
  {
    company: 'TTEC',
  ...
  },
  {
    ...
    pay: '$14-18/hour',
    type: 'Full-Time',
    description: 'Handle customer inquiries for healthcare, insurance, retail, and financial services clients. Fully remote with medical insurance, 401(k), and paid volunteer time for full-time ambassadors.',
    requirements: ['Own computer and headset', 'Reliable internet', 'Flexible availability'],
    link: 'https://theapplicantmanager.com/careers?co=av',
    hiring: true,
  },
  {
    company: 'CrowdStrike',
    title: 'Remote Tech & Security Roles',
    pay: '$25-60+/hour',
    type: 'Full-Time',
    description: 'Remote-first cybersecurity company hiring for sales, marketing, engineering, and finance. Stock purchase plan, unlimited PTO, and parental benefits.',
    requirements: ['Varies by role', 'Tech background preferred', 'Self-motivated'],
    link: 'https://crowdstrike.wd5.myworkdayjobs.com/crowdstrikecareers',
    hiring: true,
  },
  {
    company: 'Hubstaff',
    title: 'Remote Support & Engineering',
    pay: '$20-45/hour',
    type: 'Full-Time',
    description: 'Fully remote time-tracking software company. Work from anywhere in the world with generous PTO, annual retreats, and paid parental leave.',
    requirements: ['Strong communication skills', 'Self-directed work style', 'Experience in your field'],
    link: 'https://hubstaff.com/jobs',
    hiring: true,
  },
  {
    company: 'Appen',
    ...
    description: 'Help train AI models by evaluating search results, transcribing audio, and rating content. Flexible schedule—work when it suits you.',
    requirements: ['Attention to detail', 'Basic tech skills', 'Reliable internet'],
  ...
  },
  {
    ...
    link: 'https://invisibletech.ai/join-us',
    hiring: true,
  },
  {
    company: 'Mozilla',
  ...
  },
  {
    ...
    title: 'Remote Healthcare & Corporate',
    pay: '$18-50+/hour',
    type: 'Full-Time',
    description: 'Ranked #2 on FlexJobs Top 100 for 2026. One of the largest health insurers with extensive remote roles in nursing, claims processing, IT, and member services. Excellent benefits including tuition assistance.',
    requirements: ['Varies by role', 'Healthcare experience preferred for clinical', 'Strong computer proficiency'],
    link: 'https://careers.elevancehealth.com/',
    hiring: true,
  },
  {
    company: 'BELAY',
  ...
  },
  {
    ...
    link: 'https://usbank.wd1.myworkdayjobs.com/US_Bank_Careers',
    hiring: true,
  },
  {
    company: 'Capital One',
  ...
  },
  {
    ...
    title: 'Remote Engineering & IT',
    pay: '$35-80+/hour',
    type: 'Full-Time',
    description: 'Ranked #3 on FlexJobs Top 100 for 2026. Global aerospace and defense leader with growing remote workforce. Roles in systems engineering, software development, cybersecurity, and project management. Excellent benefits and clearance opportunities.',
    requirements: ['Relevant degree or experience', 'US citizenship for most roles', 'Security clearance may be required'],
    link: 'https://www.lockheedmartinjobs.com/remote-and-hybrid-jobs',
    hiring: true,
  },
  {
    ...
    pay: '$18-45/hour',
    type: 'Full-Time',
    description: 'Ranked #8 on FlexJobs Top 100 for 2026. Major healthcare company with extensive remote positions in claims processing, care management, member services, and IT. Strong benefits and growth opportunities in the healthcare sector.',
    requirements: ['Healthcare or insurance background preferred', 'Strong computer skills', 'Detail-oriented'],
    link: 'https://jobs.centene.com/',
    hiring: true,
  },
]
